...
func TestPostUser(t *testing.T) {
	...
	person, _ := json.Marshal(DummyUser{Name: "king", Address: model.Address{Addresss: "Guntur", Longitude: 123.3, Latitude: 13.32}, DOB: "2003-01-02", Description: "i am bad boy"})
...
func TestGetALLUser(t *testing.T) {
	...
	fmt.Println(res.Data["data"][0].ID)
...
func TestUpdateUser(t *testing.T) {
	...
	person, _ := json.Marshal(map[string]string{"name": "raju", "description": "I am Bad Boy"}) // Updating User
	UserDescription := "I am Bad Boy"
	UserName := "raju"
	...
	assert.Equal(t, UserDescription, idObj.Description) // Checking Updated Description
